                    ...
                    <div class="col-12">
                        <div class="card filter-tab m-0">
                            <div class="card-header">
                                ...
                                <div class="filter-nav"><a href="#" class="active">All</a><a
                                        href="#">Games</a><a href="#">Artwork</a></div>
                            </div>
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <div class="text-end">
                                                        <p class="mb-2">Current Bid : <strong
                                                                class="text-primary">0.15
                                                                <!-- --> ETH
                                                            </strong></p>
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                <div class="items-img position-relative"><img src="images/items/2.jpg"
                                                        class="img-fluid rounded mb-3" alt=""><img
                                                        src="images/avatar/2.jpg" class="creator" width="50"
                                                        alt=""></div>
                                                <h4 class="card-title">Liguid Wave</h4>
                                                <p></p>
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                <div class="items-img position-relative"><img src="images/items/3.jpg"
                                                        class="img-fluid rounded mb-3" alt=""><img
                                                        src="images/avatar/3.jpg" class="creator" width="50"
                                                        alt=""></div>
                                                <h4 class="card-title">Liguid Wave</h4>
                                                <p></p>
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                <div class="items-img position-relative"><img src="images/items/4.jpg"
                                                        class="img-fluid rounded mb-3" alt=""><img
                                                        src="images/avatar/4.jpg" class="creator" width="50"
                                                        alt=""></div>
                                                <h4 class="card-title">Liguid Wave</h4>
                                                <p></p>
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                <div class="items-img position-relative"><img src="images/items/5.jpg"
                                                        class="img-fluid rounded mb-3" alt=""><img
                                                        src="images/avatar/5.jpg" class="creator" width="50"
                                                        alt=""></div>
                                                <h4 class="card-title">Liguid Wave</h4>
                                                <p></p>
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                <div class="items-img position-relative"><img src="images/items/6.jpg"
                                                        class="img-fluid rounded mb-3" alt=""><img
                                                        src="images/avatar/6.jpg" class="creator" width="50"
                                                        alt=""></div>
                                                <h4 class="card-title">Liguid Wave</h4>
                                                <p></p>
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                <div class="items-img position-relative"><img src="images/items/7.jpg"
                                                        class="img-fluid rounded mb-3" alt=""><img
                                                        src="images/avatar/7.jpg" class="creator" width="50"
                                                        alt=""></div>
                                                <h4 class="card-title">Liguid Wave</h4>
                                                <p></p>
                                                <div class="d-flex justify-content-between">
                                        ...
                                        <div class="card items">
                                            <div class="card-body">
                                                <div class="items-img position-relative"><img src="images/items/8.jpg"
                                                        class="img-fluid rounded mb-3" alt=""><img
                                                        src="images/avatar/8.jpg" class="creator" width="50"
                                                        alt=""></div>
                                                <h4 class="card-title">Liguid Wave</h4>
                                                <p></p>
                                                <div class="d-flex justify-content-between">
...
<!-- Mirrored from enftx-html.vercel.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Mar 2024 10:48:45 GMT -->
{{-- 
</html> --}}
@endsection
