        ...
        <div class="container-fluid">
            <div class="cs-main_header_in">
                <div class="cs-main_header_left">
                    <a class="cs-site_branding" href="http://127.0.0.1:8000/"><img src="{{ asset('images/anazor.svg') }}"
                            style="    margin: 0px 0px 0px 14px;padding: 3px;height: 25px;" alt="Logo">
                    </a>
                </div>
                            ...
                            @if (Auth::check())
                                ...
                                @else
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="cs-btn cs-style1"><span>Register</span></a>
