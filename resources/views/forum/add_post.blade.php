...
@section('content')
    ...
    <section class="cs-page_head cs-bg"
        ...
        <div class="container">
            <div class="text-center">
                <h1 class="cs-page_title">Add Post</h1>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/forum/" class="cs-btn cs-style1">Forum</a></li>
                </ol>
            </div>
        </div>
    </section>
    ...
    <div class="container">
        <form action="{{ route('forum.post.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-lg-6">
                <label for="Post Content" class="cs-form_label">Post Content</label>
                <div class="cs-form_field_wrap">
                    <textarea cols="30" rows="5" placeholder="e. g. Content" class="cs-form_field" id="description"
