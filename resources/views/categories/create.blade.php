                            ...
                            <div class="mb-3">
                                ...
                                <div class="cs-file_wrap">
                                    <div class="cs-file_in">
                                        <svg class="cs-icon" width="46" height="47" viewBox="0 0 46 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="cs-close_file" title="Close">
                                        <svg class="cs-icon" width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <input type="file" class="cs-file" id="image" name="image" accept="image/*">
                                    <img id="image-preview" class="cs-preview" alt="Image preview">
                                </div>
                            </div>
...
<!-- Add CSS styles for image upload interface -->
<style>
    .cs-file_wrap {
        position: relative;
        width: 100%;
...
<script>
    ...
    document.querySelector('.cs-close_file').addEventListener('click', function () {
