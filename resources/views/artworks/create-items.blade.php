            ...
            <div class="cs-main_header_right">
                      ...
                      <ul class="cs-nav_list">
                        ...
                        <li class="menu-item-has-children">
                          ...
                          <ul>
                            ...
                            <li>
                              <a href="explore-details.html">Explore Details</a>
                            </li>
              ...
              <div class="cs-header_btns_wrap">
                <div class="cs-header_btns">
                  ...
                  <a href="connect-wallet.html" class="cs-btn cs-style1"
          ...
          <div class="cs-profile_sidebar cs-white_bg cs-box_shadow">
            <div class="cs-profile_info">
              <div class="cs-profile_pic">
                <img src="../assets/img/avatar/avatar_29.png" alt="" />
              </div>
            ...
            <ul class="cs-profile_nav cs-mp0">
                ...
                <a href="user-profile.html">
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="currentColor"
                      mask="url(#path-1-inside-1_1353_5399)"
                    />
                  </svg>
              ...
              <li>
                <a href="create-items.html" class="active">
                  <svg
                    width="15"
                    height="14"
                    viewBox="0 0 15 14"
              ...
              <li>
                <a href="user-wallet.html">
                  ...
                  >
                    <path
                      d="M13.3359 9.5625H14.4609V10.6875H13.3359V9.5625Z"
                      fill="currentColor"
                    />
                    <path
