    ...
    <form class="row" method="POST" action="{{ route('artworks.store') }}" enctype="multipart/form-data">
                ...
                <div class="cs-close_file" title="Close">
                    <svg width="33" height="33" viewBox="0 0 33 33" fill="none"
                        ...
                        <path
                            ...
                            fill="white" />
                        <defs>
                            <linearGradient id="paint0_linear_1353_4256" x1="0.421875" y1="0.163086" x2="38.7886"
                                y2="19.5877" gradientUnits="userSpaceOnUse">
        ...
        <div class="col-lg-6">
            ...
            <div class="cs-form_field_wrap">
                <input type="text" class="cs-form_field" placeholder="e. g. 'NFT Art'" id="title" name="title"
                    value="{{ old('title') }}" required />
            </div>
            <div class="cs-height_20 cs-height_lg_20"></div>
            <label for="price" class="cs-form_label" id="price" name="price" value="{{ old('price') }}"
                required>Item price</label>
            <div class="cs-form_field_wrap">
                <input type="text" class="cs-form_field" placeholder="e. g. 20$" />
            </div>
            <div class="cs-height_20 cs-height_lg_20"></div>
        ...
        <div class="col-lg-6">
            ...
            <div class="cs-form_field_wrap">
                <textarea cols="30" rows="5" placeholder="e. g. Item description" class="cs-form_field" id="description"
