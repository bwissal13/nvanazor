...
<body>
    ...
    <div class="container">
        ...
        <div class="cs-prifile_wrap">
            ...
            {{-- <!-- Modal Template -->
    <div id="bid_modal" style="display: none;">
        <div class="cs-bid_card">
            <!-- Modal content -->
            <h2 class="cs-title_title" id="modal_title"></h2>
            <div class="cs-bid_info" id="modal_content">
                <!-- Artwork information will be dynamically added here -->
                <ul>
                    <li>
                        <span>Title: <span id="modal_artwork_title"></span></span>
                    </li>
                    <li>
                        <span>Description: <span id="modal_artwork_description"></span></span>
                    </li>
                    <li>
                        <span>Price: <span id="modal_artwork_price"></span></span>
                    </li>
...
{{-- 
            {{-- <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                            ...
                            <div class="cs-card_info">
                                ...
                                <h3 class="cs-card_title"><a href="explore-details.html">Cool octopus traveling</a>
                                </h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                            ...
                            <div class="cs-card_info">
                                ...
                                <h3 class="cs-card_title"><a href="explore-details.html">Octopus eating icecrem</a>
                                </h3>
                                <div class="cs-card_price">Current Bid: <b class="cs-primary_color">0.09 ETH 1/9</b>
                                </div>
                                <hr>
                                <div class="cs-card_footer">
                                    <span class="cs-card_btn_1" data-modal="#history_1">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="cs-card cs-style4 cs-box_shadow cs-white_bg">
                            ...
                            <div class="cs-card_info">
                                ...
                                <h3 class="cs-card_title"><a href="explore-details.html">Small kid with orange</a>
                                </h3>
    ...
    <script>
        $(document).ready(function() {
            // Event handler for clicking on "Place Bid" button
            $('a.cs-card_btn_2').click(function(event) {
                event.preventDefault();

                // Retrieve artwork data from the clicked button's data attribute
                var artworkData = $(this).data('artwork');

                // Populate modal title with artwork title
                $('#modal_title').text(artworkData.title);

                // Construct HTML content for the modal
                var modalContent = `
            <span>Description: ${artworkData.description}</span>
            <span>Price: $${artworkData.price}</span>
            <!-- You can add more information here -->
        `;

                // Populate modal content with artwork information
                $('#modal_content').html(modalContent);
                $('#modal_title').text('Place a Bid'); // Set modal title
                $('#modal_artwork_title').text(artworkData.title); // Set artwork title
                $('#modal_artwork_description').text(artworkData.description); // Set artwork description
                $('#modal_artwork_price').text('$' + artworkData.price); // Set artwork price
                // Add more lines for other artwork information if needed
                // Show the modal
                $('#bid_modal').show();
            });
